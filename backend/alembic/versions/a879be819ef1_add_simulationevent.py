...
Revision ID: a879be819ef1
Revises: 77690ecf239b
Create Date: 2026-06-07 16:48:33.944423
...
revision: str = 'a879be819ef1'
down_revision: Union[str, None] = '77690ecf239b'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_simulation_events_id', table_name='simulation_events')
    ...
    op.drop_index('idx_offline_uss_by_usersess', table_name='offline_user_session')
    op.drop_index('idx_offline_uss_createdon', table_name='offline_user_session')
    op.drop_index('idx_offline_uss_preload', table_name='offline_user_session')
    ...
    op.drop_index('idx_offline_css_preload', table_name='offline_client_session')
...
def downgrade() -> None:
    ...
    sa.UniqueConstraint('client_id', 'client_storage_provider', 'external_client_id', 'user_id', name='uk_jkuwuvd56ontgsuhogm8uewrt'),
    postgresql_ignore_search_path=False
    )
    ...
    op.create_index('idx_offline_css_preload', 'offline_client_session', ['client_id', 'offline_flag'], unique=False)
    ...
    op.create_index('idx_offline_uss_preload', 'offline_user_session', ['offline_flag', 'created_on', 'user_session_id'], unique=False)
    op.create_index('idx_offline_uss_createdon', 'offline_user_session', ['created_on'], unique=False)
    op.create_index('idx_offline_uss_by_usersess', 'offline_user_session', ['realm_id', 'offline_flag', 'user_session_id'], unique=False)
    ...
    sa.Column('target', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    ...
    sa.Column('global_resilience', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='simulation_events_pkey')
    )
    op.create_index('ix_simulation_events_id', 'simulation_events', ['id'], unique=False)
    op.create_index('ix_simulation_events_event_type', 'simulation_events', ['event_type'], unique=False)
